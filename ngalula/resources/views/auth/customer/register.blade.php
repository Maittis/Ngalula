...
@section('title', 'Customer Registration - Ngalula Wellness Center')
...
<div class="auth-container">
    <div class="auth-card">
        ...
        <div class="auth-right">
            ...
            <p class="auth-description">Join us to start your wellness journey</p>
            
            <form id="registerForm" method="POST" action="{{ route('register.customer.store') }}">
                @csrf
            ...
            <div class="auth-links">
                <p>Already have an account? <a href="{{ route('login.customer') }}">Sign in</a></p>
            </div>
            
            <div class="mt-4 text-center">
                <small class="text-muted">Other Registrations:</small>
                <div class="mt-2">
                    <a href="{{ route('register.therapist') }}" class="btn btn-outline-primary btn-sm">
                        <i class="fas fa-user-md me-1"></i> Register as Therapist
                    </a>
                </div>
            </div>
        </div>
