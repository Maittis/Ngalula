...
@section('title', 'Therapist Login - Ngalula Wellness Center')
    ...
    <div class="auth-card">
        ...
        <div class="auth-left">
            ...
            <div class="auth-features">
                ...
                <div class="feature-item">
                    <div class="feature-icon"><i class="fas fa-check-circle"></i></div>
                    <span>View Client Appointments</span>
                </div>
                <div class="feature-item">
                    <div class="feature-icon"><i class="fas fa-check-circle"></i></div>
        ...
        <!-- Right Side - Therapist Login Form -->
        <div class="auth-right">
            <div class="role-badge">
                <i class="fas fa-user-md"></i> Therapist Portal
            </div>
            <h2 class="auth-title">Welcome Back</h2>
            <p class="auth-description">Sign in to your therapist account</p>
            
            <form id="loginForm" method="POST" action="{{ route('login.therapist.store') }}">
                @csrf
            ...
            <div class="auth-links">
                <p>Don't have an account? <a href="{{ route('register.therapist') }}">Create Therapist Account</a></p>
            </div>
