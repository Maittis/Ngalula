...
@section('title', 'Therapist Registration - Ngalula Wellness Center')
...
<div class="auth-container">
    <div class="auth-card">
        ...
        <!-- Right Side - Therapist Registration Form -->
        <div class="auth-right">
            <div class="role-badge">
                <i class="fas fa-user-md"></i> Therapist Registration
            </div>
            <h2 class="auth-title">Join Our Team</h2>
            <p class="auth-description">Register as a professional therapist</p>
            
            <form id="registerForm" method="POST" action="{{ route('register.therapist.store') }}">
                @csrf
            ...
            <div class="auth-links">
                <p>Already have an account? <a href="{{ route('login.therapist') }}">Sign in</a></p>
            </div>
            
            <div class="mt-4 text-center">
                <small class="text-muted">Other Registrations:</small>
                <div class="mt-2">
                    <a href="{{ route('register.customer') }}" class="btn btn-outline-primary btn-sm">
